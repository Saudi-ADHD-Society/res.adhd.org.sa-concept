...
const Conference2012PlaGroup3Page = ({ basePath = '/res.adhd.org.sa-concept/' }) => (
  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Second Saudi Pediatric Leadership Alliance (PLA), Group 3</h1>
          <div className="flex items-center text-slate-600 mt-2">
            <Calendar size={18} className="mr-2" aria-hidden="true" />
            <span className="font-medium">8–10 December 2012</span>
          </div>
        </div>
      </div>
      
      <p className="text-slate-600 max-w-3xl">
        Second PLA program for Group 3 participants.
      </p>
    </div>
...
export default Conference2012PlaGroup3Page;
