...
const Conference2021AgreeRexWorkshopPage = ({ basePath = '/res.adhd.org.sa-concept/' }) => (
  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Satellite Workshop — AGREE‑REX Appraisal & Implementation of the Saudi ADHD Clinical Practice Guideline</h1>
          <div className="flex items-center text-slate-600 mt-2">
            <Calendar size={18} className="mr-2" aria-hidden="true" />
            <span className="font-medium">6 March 2021</span>
          </div>
        </div>
      </div>
...
export default Conference2021AgreeRexWorkshopPage;
