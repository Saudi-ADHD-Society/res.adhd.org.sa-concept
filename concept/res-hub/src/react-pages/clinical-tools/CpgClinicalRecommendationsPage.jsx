            ...
            <section id="recognition-identification-and-referral" className="scroll-mt-20 mb-8">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>people with other neurodevelopmental disorders (for example, autism spectrum disorder, tic disorders, intellectual disability and specific learning difficulties). See p24, Early Recognition and Diagnosis, Evidence-Based CPG for Management of Children with ASD (Saudi Health Council, 2022). [<a href={getUpdateLinkHref('Update-2022-5')} className="text-emerald-700 hover:underline">Update 2022-5</a>] [<a href={getUpdateLinkHref('Update-2023-2')} className="text-emerald-700 hover:underline">Update 2023-2</a>]</li>
            ...
            <section id="medication" className="scroll-mt-20 mb-8">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <p>
                  ...
                  Offer methylphenidate (either short or long acting) as the first line pharmacological treatment for children aged 5 years and over and young people with ADHD, taking into consideration that this is an off-label use for children aged between 5 and 6 years. [<a href={getUpdateLinkHref('Update-2022-2')} className="text-emerald-700 hover:underline">Update 2022-2</a>]
                </p>
                ...
                <p>
                  ...
                  Offer lisdexamfetamine or methylphenidate as first-line pharmacological treatment for adults with ADHD. This is an off-label use of lisdexamfetamine for adults with no ADHD symptoms in childhood. [<a href={getUpdateLinkHref('Update-2022-3a')} className="text-emerald-700 hover:underline">Update 2022-3a</a>] Not all preparations of methylphenidate are licensed for treating symptoms of ADHD in adults. [<a href={getUpdateLinkHref('Update-2022-3b')} className="text-emerald-700 hover:underline">Update 2022-3b</a>]
                </p>
                ...
                <p>
                  ...
                  Offer the same medication choices to people with ADHD and anxiety disorder, tic disorder or autism spectrum disorder as other people with ADHD. See p52, Pharmacological Interventions, Evidence-Based CPG for Management of Children with ASD (Saudi Health Council, 2022). [<a href={getUpdateLinkHref('Update-2022-6')} className="text-emerald-700 hover:underline">Update 2022-6</a>]
                </p>
                ...
                <p>
                  ...
                  Think about using a modified-release preparation of methylphenidate in the morning and an immediate-release preparation of methylphenidate at another time of the day to extend the duration of effect. [<a href={getUpdateLinkHref('Update-2023-1')} className="text-emerald-700 hover:underline">Update 2023-1</a>]
                </p>
            ...
            <section id="maintenance-and-monitoring" className="scroll-mt-20 mb-8">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <p>
                  ...
                  If tics are stimulant related, reduce the stimulant dose, or consider changing to guanfacine (in children aged 5 years and over and young people only), atomoxetine (off-label use for adults with no ADHD symptoms in childhood) [<a href={getUpdateLinkHref('Update-2022-4a')} className="text-emerald-700 hover:underline">Update 2022-4a</a>], clonidine (off-label use for children) [<a href={getUpdateLinkHref('Update-2022-4b')} className="text-emerald-700 hover:underline">Update 2022-4b</a>], or stopping medication. Clonidine should only be considered for people under 18 years after advice from a tertiary ADHD service. [<a href={getUpdateLinkHref('Update-2022-4c')} className="text-emerald-700 hover:underline">Update 2022-4c</a>]
                </p>
