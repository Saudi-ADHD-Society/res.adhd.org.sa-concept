      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => onNavigate('current-research')}
        ...
        <div className="relative pl-8 md:pl-12">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex gap-3">
               ...
               <button onClick={() => onNavigate('ishraq-grant')} className="text-sm text-emerald-700 font-medium underline decoration-emerald-200 hover:decoration-emerald-500 underline-offset-4">View Grant Details</button>
            </div>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-emerald-900 rounded-2xl p-8 text-white relative overflow-hidden group">
           ...
           <div className="relative z-10">
             ...
             <button onClick={() => onNavigate('interactive-scales')} className="bg-emerald-500 hover:bg-emerald-400 text-emerald-950 px-6 py-3 rounded-lg font-bold transition-colors">
               Launch Tools
             </button>
           </div>
        </div>
