...
const ResearchProjectsPage = ({ onNavigate }) => (
  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <button
        ...
        className="group text-left bg-white p-8 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all"
      >
      ...
      {/* Research Output */}
      <button
        onClick={() => onNavigate('research-output')}
        className="group text-left bg-white p-8 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all"
      >
