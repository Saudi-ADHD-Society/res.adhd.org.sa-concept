          ...
          <section id="adaptation-process-methodology" className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm scroll-mt-20">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm md:text-base">
                  See <button onClick={() => onNavigate('adhd-cpg-about-acknowledgements')} className="text-emerald-700 hover:underline">CPG Adaptation Committee</button>
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm md:text-base">
                      See <button onClick={() => onNavigate('adhd-cpg-about-acknowledgements')} className="text-emerald-700 hover:underline">External Reviewers: Clinical Content</button>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm md:text-base">
                      See <button onClick={() => onNavigate('adhd-cpg-about-acknowledgements')} className="text-emerald-700 hover:underline">External Reviewers: Methodology</button>
                    </p>
                  </div>
                </div>
              </div>
