...
import saudiAdhdCpgThumb from '../../assets/saudi-adhd-cpg-thumb.png';
import saudiAdhdCpgArThumb from '../../assets/saudi-adhd-cpg-ar-thumb.png';
import paper2Thumb from '../../assets/paper2-thumb.png';
import journalPoneThumb from '../../assets/journal-pone-thumb.png';
import prosperoThumb from '../../assets/prospero-thumb.png';
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              href="/Saudi-ADHD-CPG-EN-1.7.0-spreads.pdf"
              download
            ...
            <a
              href="/Saudi-ADHD-CPG-EN-1.7.0.pdf"
              download
              className="inline-flex items-center text-emerald-700 hover:text-emerald-800 font-semibold text-sm"
            >
              <Download size={16} className="mr-2" />
    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              href="/Saudi-ADHD-CPG-AR-1.7.0-spreads.pdf"
              download
              className="inline-flex items-center text-emerald-700 hover:text-emerald-800 font-semibold text-sm"
            >
              <Download size={16} className="mr-2" />
            ...
            <a
              href="/Saudi-ADHD-CPG-AR-1.7.0.pdf"
              download
              className="inline-flex items-center text-emerald-700 hover:text-emerald-800 font-semibold text-sm"
            >
              <Download size={16} className="mr-2" />
