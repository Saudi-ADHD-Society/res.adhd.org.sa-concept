...
import { Heart, ArrowLeft, ArrowRight, Brain, BookOpen, Activity, AlertTriangle, Shield, Users } from 'lucide-react';
    ...
    <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        >
          ...
          Previous: ADHD Across the Lifespan
        </button>
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex items-center text-emerald-700 font-semibold hover:text-emerald-800"
          >
            Next: Evidence-Based Treatments
